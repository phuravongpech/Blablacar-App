...
class RidePrefModal extends StatefulWidget {
  final RidePreference?
      initialPref; // TODO 7 : We should pass the current prefs to this moda;
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            ...
            child: RidePrefForm(
              // TODO 7 : The form should be displayed with the modal current prefs
              initialPreference: widget.initialPref,
              onSubmit: onSubmit,
            ),
          )),
        ],
